...
parser.add_argument('--F_star', default=1, type=int,
                    metavar='N', help='Initial F star setting (default: 1)')
parser.add_argument('--psi_2', default=2, type=int,
                    metavar='N', help='Initial Psi 2 setting (default: 2)')
parser.add_argument('--psi_1', default=200, type=int,
                    metavar='N', help='Initial Psi 1 setting (default: 200)')
parser.add_argument('--tau', default=1, type=int,
                    metavar='N', help='Initial tau setting (default: 1)')
...
plt.ylim(0, 4)
plt.legend()
plt.savefig('./RFR_plot_case_regime_3.png')